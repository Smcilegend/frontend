function moduleProject3() {
  ...
  function buildLearnerCard(learner, languages) {
    ...
    const favLangP = document.createElementNS('p')
    ...
    card.addEvenrListener('click', evt => {
  ...
  let companyInfoDiv = document.createElement('p')
  ...
  let (let platform in footerData.socialMedia) {
  ...
  copyright.textContent = `${footeData.companyName.toUpperCase() ${cuurentYear}}`
